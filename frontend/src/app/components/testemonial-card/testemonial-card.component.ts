...
export class TestemonialCardComponent {
  faStar = faStar;
  images = [
    {img: 'team-1.jpg', doctor: 'Dr. James Thompson', hospital: "St. Luke's Medical Center, Chief of Cardiology", header: 'Exceptional Equipment, Exceptional Care',
      ...
      {img: 'team-2.jpg', doctor: 'Dr. Emily Rodriguez', hospital: "Mercy General Hospital, Head of Radiology", header: 'Innovative Solutions for Quality Healthcare',
      ...
      {img: 'team-3.jpg', doctor: 'Dr. Michael Turner', hospital: " Metropolitan General Hospital, Director of Surgery", header: 'Empowering Surgical Excellence',
